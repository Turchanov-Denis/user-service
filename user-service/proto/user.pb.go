...
// Переименовали с User на ProtoUser
...
func (x *ProtoUser) GetAvatar() []byte {
	if x != nil {
		return x.Avatar
	}
	return nil
...
type CreateUserRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	User          *ProtoUser             `protobuf:"bytes,1,opt,name=user,proto3" json:"user,omitempty"` // теперь ProtoUser
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateUserRequest) GetUser() *ProtoUser {
	if x != nil {
		return x.User
	}
	return nil
...
func (x *GetUserResponse) GetUser() *ProtoUser {
	if x != nil {
		return x.User
	}
	return nil
...
const file_user_proto_rawDesc = "" +
	...
	"\x04user\x18\x01 \x01(\v2\x0f.user.ProtoUserR\x04user\">\n" +
	...
	"\x04user\x18\x01 \x01(\v2\x0f.user.ProtoUserR\x04user\x12\x14\n" +
	"\x05found\x18\x02 \x01(\bR\x05found2\x86\x01\n" +
	"\vUserService\x12?\n" +
	"\n" +
	"CreateUser\x12\x17.user.CreateUserRequest\x1a\x18.user.CreateUserResponse\x126\n" +
	"\aGetUser\x12\x14.user.GetUserRequest\x1a\x15.user.GetUserResponseB\x14Z\x12user-service/protob\x06proto3"
...
var file_user_proto_goTypes = []any{
	(*ProtoUser)(nil),          // 0: user.ProtoUser
...
var file_user_proto_depIdxs = []int32{
	0, // 0: user.CreateUserRequest.user:type_name -> user.ProtoUser
	0, // 1: user.GetUserResponse.user:type_name -> user.ProtoUser
